...
import { getTeacherProfile, updateTeacherProfile, changePassword } from "../../api/teacherService";
...
function TeacherProfile() {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      const response = await updateTeacherProfile(user.id, profile);
      ...
      if (response.success) {
        ...
        if (response.teacher?.name) {
          const updatedUser = { ...user, name: response.teacher.name };
        ...
        <Col lg={4}>
          <div className="card-modern">
            <div className="card-body-modern text-center">
              ...
              <h4 className="fw-bold mb-1">{profile.name || "Teacher"}</h4>
